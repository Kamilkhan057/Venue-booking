...
const [step, setStep] = useState("form");
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 to-blue-200 px-4">
      <div className="bg-white shadow-xl rounded-3xl p-8 w-full max-w-lg">
        <h2 className="text-3xl font-bold text-center text-blue-600 mb-6">Directer Register</h2>
  ...
  <Link to="/login/director" className="text-blue-600 font-semibold hover:underline ml-1">
    Back to Login
  </Link>
</div>
          </form>
...
export default DirecterRegister;
